...
```{r age_sex, fig.cap="Figure 5. Age Distributions by Sex and Education Category"}
...
```{r total_activity, fig.width = 7, fig.height = 5, fig.cap="Figure 6. Total Activity vs Age by Gender and Education Level" }
total_activity_df = 
  nhanes_df |> 
...
```{r total, fig.width = 8, fig.height = 5, fig.cap="Figure 7. 24-Hour Activity Time Courses by Education Level and Gender"}

...
*   There is a typical seasonal difference between winter and summer. July consistently shows much higher average maximum temperatures (20 to 30°C) compared to January (-10 to 10°C). 
...
*   Outliers: There are a few sharp drops. For example, July showing one or two sudden drops below 20°C and January dipping below -10°C. Besides, compared to the July data, the January data fluctuated more between 1981 and 2010 and had discrete extremes at some stations in 2004.
...
*   For Less than High School category, a clear decline in activity as age increases. Both men and women show a sharp drop after the age of 60.
*   For  High School Equivalent category, Activity declines gradually, but there is an increase around age 70 before dropping again.
*  For More than High School category, activity levels are lower for both men and women, especially in early adulthood. There is less variability, with a smoother decline across all ages.
...
```{r duration2024, message = FALSE, warning=FALSE,  fig.width = 10, fig.height = 5, fig.cap="Figure 9. Impact of Month, Membership Status, and Bike Type on Ride Duration (2024)"}
...
*   Casual riders tend to have a more varied distribution of ride durations compared to members. In January, the distribution of ride durations for both bike types is relatively concentrated under 25 minutes, with a few longer rides extending up to 100+ minutes.  In July, the pattern is similar, though the distribution is slightly wider, with some riders using electric bikes for even longer rides.

*   Members have a tighter distribution, indicating that most of their rides are shorter. Both classic and electric bikes tend to have ride durations predominantly under 25 minutes. 

...
```{r MAXMIN, fig.cap="Figure 3. Density Plot of Maximum vs Minimum Temperature"}
...
```{r SNOWFALL_DENSITY, fig.cap="Figure 4. Density Plot of Maximum vs Minimum Temperature"}
p_snowfall = df %>%
...
```{r fig.width = 7, fig.height = 14, fig.cap="Distribution of Snowfall Values (0 < Snowfall < 100)"}
p2 = ny_noaa |>
